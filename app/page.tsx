      ...
      <div className="ground g4" aria-hidden="true" />
        <section>
          <div className="plate">
            ...
            <p className="lede col">
              ...
              strong quantitative abilities. Members learn the mechanics of
        ...
        <Section eyebrow="What we do" title="Three things, done properly">
          <div className="grid g3">
            ...
            <div className="panel">
              <h4>Research</h4>
              <p className="note">
                Small teams carrying out deep research into specific areas, from systematic strategies to market microstructure, writing up what they find. The first projects launch in Michaelmas 2026.
              </p>
            </div>
          </div>
        </Section>
        ...
        <Section eyebrow="The society" title="Built around real participation">
          ...
          <p className="col">
            ...
            ability and the willingness to test it publicly on a live market.
          </p>
